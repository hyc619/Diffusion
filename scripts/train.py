...
def create_argparser():
    ...
    defaults = dict(
        ...
        log_interval=50,
        save_interval=50000,
        resume_checkpoint="/data/hanyc/project/Diffusion-LM-main/improved-diffusion/diffusion_models/diff_BART_diffusion_pad_rand32_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_conditionprompt_xstart_e2e/model200000.pt",
        use_fp16=False,
    ...
    text_defaults = dict(modality='text',
                         ...
                         data_movie_path='/data/hanyc/project/Diffusion-LM-main/datasets',)
