...
def main():
    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute':
                model_control = Classifier_GPT2.from_pretrained('/data/hanyc/project/Diffusion-LM-main/classifier_models/e2e-back_e=2_b=10_m=gpt2_wikitext-103-raw-v1_101_wp_full_multi_sqrt_16').cuda()

                control_label_lst = []
                with open('/data/hanyc/project/Diffusion-LM-main/datasets/control_target/target_attribute_small.json', 'r') as controlf:
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                model_control = Classifier_Tree.from_pretrained(
                    '/data/hanyc/project/Diffusion-LM-main/classifier_models/e2e-tgt-tree_e=2_b=10_m=bert-base-uncased_'
                    'wikitext-103-raw-v1_101_wp_None').cuda()
                ...
                ###############
                control_label_lst = []
                with open('/data/hanyc/project/Diffusion-LM-main/datasets/control_target/target_tree.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
    ...
    if args.verbose == 'pipe':
        ...
        out_path_pipe = os.path.join('/data/hanyc/project/Diffusion-LM-main/improved-diffusion/out_gen/', f"{model_base_name}.infill_{args.eval_task_}_{args.notes}.json")
