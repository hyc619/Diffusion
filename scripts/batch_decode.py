...
full_lst = glob.glob(sys.argv[1]) #返回匹配的路径列表
...
for lst in full_lst:
    ...
    if modality == 'e2e-tgt' or modality == 'e2e' or modality == 'BART_diffusion':
    ...
    print('out_path2', out_path2)
    print('output_cands', output_cands)
